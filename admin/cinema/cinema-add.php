<?php 
    ...
    insertDBdata("INSERT INTO `cinema` (`cinema_id` , `cinema_date`, `cinema_time`, `cinema_title`, `cinema_title_data`, `cinema_place`) VALUES (NULL, '$cinema_date', '$cinema_time', '$cinema_title', '$cinema_title_data', '$cinema_place')");
